...
class UniversityDepatment(models.Model):
    ...
    name = fields.Char("Departmemt name")
    code = fields.Char("Code")
    student_associated = fields.Many2one('student.student', string="Associated Student", help="Select the associated student.")
    associated_student_full_name = fields.Char(string="Associated Student Full Name", compute='_compute_associated_student_file_numbers', store=True)
